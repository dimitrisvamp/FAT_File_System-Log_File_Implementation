...
{
	/* Evdomo printk gia fat_file_operatios */
	printk(KERN_INFO "fat generic compat ioctl 7");
		...
		u32 request_mask, unsigned int flags)
{
	...
	/*Ogdoo printk gia msdos_dir_inode_operations */
	printk(KERN_INFO "fat getattr 8");
...
int fat_setattr(struct dentry *dentry, struct iattr *attr)
{
	...
	/* Evdomo printk gia vfat_dir_inode_operations */
	printk(KERN_INFO "fat setattr 77");
