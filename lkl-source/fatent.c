...
#include "fat.h"
#define N 1024		/* define to N pou tha to xrisimopoihsw sto descriptor_array parakatw opws kai sto inode.c */
			 ...
			 int offset, sector_t blocknr)
{
	...
	/* Trito printk gia fat16_ops */
	printk(KERN_INFO "fat16 ent bread 3");

	/* Trito printk gia fat32_ops */
...
int fat_free_clusters(struct inode *inode, int cluster)
{
	...
	char *descriptor_array;			/* Pinakas pou tha kratw mesa tis allages twn domwn gia na tis kanw sth sunexeia sys_write */
	int bravo;
	int write_value;			/* returned value for sys_write */
	nr_bhs = 0;
